        ...
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-body p-1">
              ...
              <h5 class="card-text text-center text-danger">Rp. <?= number_format(intval($row['product_price']), 0, ',', '.') ?></h5>
              <button class="btn btn-outline-primary btn-block viewDetailBtn" data-toggle="modal" data-target="#detailModal" data-detail="<?= htmlspecialchars($row['detail']) ?>">Lihat Detail</button>
            </div>
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                ...
                <input type="hidden" class="detail" value="<?= $row['detail'] ?>">
                <input type="hidden" class="pimage" value="<?= $row['product_image'] ?>">
                <input type="hidden" class="pcode" value="<?= $row['product_code'] ?>">
                <button class="btn btn-success btn-block addItemBtn"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Pesan</button>
              </form>
